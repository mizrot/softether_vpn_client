...
## What *Minimum* means?
I want to establish a VPN connection via remote VPS server.
So this app's goal is to implement minimum features to do that.
...
- [ ] works with self-certified servers
